...
public class 两数相加 {
    ...
    public static void main(String[] args) {
        ...
        ListNode result = solution.addTwoNumbers(ListNode.buildListNodeByArray(new int[]{9, 9, 9, 9, 9, 9, 9}),
                ListNode.buildListNodeByArray(new int[]{9, 9, 9, 9}));
        System.out.println(ListNode.resetListNodeToList(result));
    }
}
